...
module mk_csr_grp5(CLK,
  ...
  reg [31 : 0] IF_ma_core_req_req_BITS_47_TO_36_23_EQ_0xB0A_2_ETC___d198,
	       x_wget__h501;
  wire [63 : 0] x__h5255,
		x__h5594,
		x__h5932,
  ...
  assign MUX_mhpmcounter_0_write_1__VAL_2 =
	     (ma_core_req_req[47:36] == 12'hB0A) ? x__h5255 : x__h7622 ;
  assign MUX_mhpmcounter_1_write_1__VAL_1 =
	     mhpmcounter_1 + { 63'd0, x__h3276 } ;
  assign MUX_mhpmcounter_1_write_1__VAL_2 =
	     (ma_core_req_req[47:36] == 12'hB0B) ? x__h5594 : x__h7960 ;
  assign MUX_mhpmcounter_2_write_1__VAL_1 =
	     mhpmcounter_2 + { 63'd0, x__h3412 } ;
  assign MUX_mhpmcounter_2_write_1__VAL_2 =
	     (ma_core_req_req[47:36] == 12'hB0C) ? x__h5932 : x__h8298 ;
  assign MUX_mhpmcounter_3_write_1__VAL_1 =
	     mhpmcounter_3 + { 63'd0, x__h3548 } ;
  assign MUX_mhpmcounter_3_write_1__VAL_2 =
	     (ma_core_req_req[47:36] == 12'hB0D) ? x__h6270 : x__h8636 ;
  assign MUX_mhpmcounter_4_write_1__VAL_1 =
	     mhpmcounter_4 + { 63'd0, x__h3684 } ;
  assign MUX_mhpmcounter_4_write_1__VAL_2 =
	     (ma_core_req_req[47:36] == 12'hB0E) ? x__h6608 : x__h8974 ;
  assign MUX_mhpmcounter_5_write_1__VAL_1 =
	     mhpmcounter_5 + { 63'd0, x__h3820 } ;
  assign MUX_mhpmcounter_5_write_1__VAL_2 =
	     (ma_core_req_req[47:36] == 12'hB0F) ? x__h6946 : x__h9312 ;
  assign MUX_mhpmcounter_6_write_1__VAL_1 =
	     mhpmcounter_6 + { 63'd0, x__h3955 } ;
  assign MUX_mhpmcounter_6_write_1__VAL_2 =
	     (ma_core_req_req[47:36] == 12'hB10) ? x__h7284 : x__h9650 ;

  // inlined wires
  assign rg_resp_to_core_1_wget =
	     { 1'd1,
	       IF_ma_core_req_req_BITS_47_TO_36_23_EQ_0xB0A_2_ETC___d198 } ;
  assign rg_resp_to_core_1_whas =
	     EN_ma_core_req &&
	     (ma_core_req_req[47:36] == 12'hB0A ||
	      ma_core_req_req[47:36] == 12'hB0B ||
	      ma_core_req_req[47:36] == 12'hB0C ||
	      ma_core_req_req[47:36] == 12'hB0D ||
	      ma_core_req_req[47:36] == 12'hB0E ||
	      ma_core_req_req[47:36] == 12'hB0F ||
	      ma_core_req_req[47:36] == 12'hB10 ||
	      ma_core_req_req[47:36] == 12'hB8A ||
	      ma_core_req_req[47:36] == 12'hB8B ||
	      ma_core_req_req[47:36] == 12'hB8C ||
	      ma_core_req_req[47:36] == 12'hB8D ||
	      ma_core_req_req[47:36] == 12'hB8E ||
	      ma_core_req_req[47:36] == 12'hB8F ||
	      ma_core_req_req[47:36] == 12'hB90 ||
	      ma_core_req_req[47:36] == 12'h32A ||
	      ma_core_req_req[47:36] == 12'h32B ||
	      ma_core_req_req[47:36] == 12'h32C ||
	      ma_core_req_req[47:36] == 12'h32D ||
	      ma_core_req_req[47:36] == 12'h32E ||
	      ma_core_req_req[47:36] == 12'h32F ||
	      ma_core_req_req[47:36] == 12'h330) ;
  ...
  assign ff_fwd_request_ENQ =
	     EN_ma_core_req && ma_core_req_req[47:36] != 12'hB0A &&
	     ma_core_req_req[47:36] != 12'hB0B &&
	     ma_core_req_req[47:36] != 12'hB0C &&
	     ma_core_req_req[47:36] != 12'hB0D &&
	     ma_core_req_req[47:36] != 12'hB0E &&
  ...
  begin
    case (ma_core_req_req[47:36])
	  ...
	  IF_ma_core_req_req_BITS_47_TO_36_23_EQ_0xB0A_2_ETC___d198 =
	      mhpmcounter_6[63:32];
      default: IF_ma_core_req_req_BITS_47_TO_36_23_EQ_0xB0A_2_ETC___d198 =
		   mhpmevent_6;
    endcase
  end
