...
//
// On Fri Sep  3 12:08:35 PDT 2021
//
//
// Ports:
// Name                         I/O  size props
...
module mk_csr_grp6(CLK,
  ...
  reg [31 : 0] IF_ma_core_req_req_BITS_47_TO_36_23_EQ_0xB11_2_ETC___d198,
	       x_wget__h501;
  wire [63 : 0] x__h5255,
		x__h5594,
		x__h5932,
  ...
  assign MUX_mhpmcounter_0_write_1__VAL_2 =
	     (ma_core_req_req[47:36] == 12'hB11) ? x__h5255 : x__h7622 ;
  assign MUX_mhpmcounter_1_write_1__VAL_1 =
	     mhpmcounter_1 + { 63'd0, x__h3276 } ;
  assign MUX_mhpmcounter_1_write_1__VAL_2 =
	     (ma_core_req_req[47:36] == 12'hB12) ? x__h5594 : x__h7960 ;
  assign MUX_mhpmcounter_2_write_1__VAL_1 =
	     mhpmcounter_2 + { 63'd0, x__h3412 } ;
  assign MUX_mhpmcounter_2_write_1__VAL_2 =
	     (ma_core_req_req[47:36] == 12'hB13) ? x__h5932 : x__h8298 ;
  assign MUX_mhpmcounter_3_write_1__VAL_1 =
	     mhpmcounter_3 + { 63'd0, x__h3548 } ;
  assign MUX_mhpmcounter_3_write_1__VAL_2 =
	     (ma_core_req_req[47:36] == 12'hB14) ? x__h6270 : x__h8636 ;
  assign MUX_mhpmcounter_4_write_1__VAL_1 =
	     mhpmcounter_4 + { 63'd0, x__h3684 } ;
  assign MUX_mhpmcounter_4_write_1__VAL_2 =
	     (ma_core_req_req[47:36] == 12'hB15) ? x__h6608 : x__h8974 ;
  assign MUX_mhpmcounter_5_write_1__VAL_1 =
	     mhpmcounter_5 + { 63'd0, x__h3820 } ;
  assign MUX_mhpmcounter_5_write_1__VAL_2 =
	     (ma_core_req_req[47:36] == 12'hB16) ? x__h6946 : x__h9312 ;
  assign MUX_mhpmcounter_6_write_1__VAL_1 =
	     mhpmcounter_6 + { 63'd0, x__h3955 } ;
  assign MUX_mhpmcounter_6_write_1__VAL_2 =
	     (ma_core_req_req[47:36] == 12'hB17) ? x__h7284 : x__h9650 ;

  // inlined wires
  assign rg_resp_to_core_1_wget =
	     { 1'd1,
	       IF_ma_core_req_req_BITS_47_TO_36_23_EQ_0xB11_2_ETC___d198 } ;
  assign rg_resp_to_core_1_whas =
	     EN_ma_core_req &&
	     (ma_core_req_req[47:36] == 12'hB11 ||
	      ma_core_req_req[47:36] == 12'hB12 ||
	      ma_core_req_req[47:36] == 12'hB13 ||
	      ma_core_req_req[47:36] == 12'hB14 ||
	      ma_core_req_req[47:36] == 12'hB15 ||
	      ma_core_req_req[47:36] == 12'hB16 ||
	      ma_core_req_req[47:36] == 12'hB17 ||
	      ma_core_req_req[47:36] == 12'hB91 ||
	      ma_core_req_req[47:36] == 12'hB92 ||
	      ma_core_req_req[47:36] == 12'hB93 ||
	      ma_core_req_req[47:36] == 12'hB94 ||
	      ma_core_req_req[47:36] == 12'hB95 ||
	      ma_core_req_req[47:36] == 12'hB96 ||
	      ma_core_req_req[47:36] == 12'hB97 ||
	      ma_core_req_req[47:36] == 12'h331 ||
	      ma_core_req_req[47:36] == 12'h332 ||
	      ma_core_req_req[47:36] == 12'h333 ||
	      ma_core_req_req[47:36] == 12'h334 ||
	      ma_core_req_req[47:36] == 12'h335 ||
	      ma_core_req_req[47:36] == 12'h336 ||
	      ma_core_req_req[47:36] == 12'h337) ;
  ...
  assign ff_fwd_request_ENQ =
	     EN_ma_core_req && ma_core_req_req[47:36] != 12'hB11 &&
	     ma_core_req_req[47:36] != 12'hB12 &&
	     ma_core_req_req[47:36] != 12'hB13 &&
	     ma_core_req_req[47:36] != 12'hB14 &&
	     ma_core_req_req[47:36] != 12'hB15 &&
  ...
  begin
    case (ma_core_req_req[47:36])
	  ...
	  IF_ma_core_req_req_BITS_47_TO_36_23_EQ_0xB11_2_ETC___d198 =
	      mhpmcounter_6[63:32];
      default: IF_ma_core_req_req_BITS_47_TO_36_23_EQ_0xB11_2_ETC___d198 =
		   mhpmevent_6;
    endcase
  end
