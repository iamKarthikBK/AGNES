...
module mkbram(CLK,
  ...
  wire [31 : 0] ram_v_mem_0_dina, ram_v_mem_0_dinb, ram_v_mem_0_doutb;
  wire [21 : 0] ram_v_mem_0_addra, ram_v_mem_0_addrb;
  wire [3 : 0] ram_v_mem_0_wea, ram_v_mem_0_web;
  ...
  wire [31 : 0] mask__h2790,
		...
		y__h2892,
		y__h4758;
  wire [23 : 0] addr__h2007, addr__h3146;
  ...
  assign ram_v_mem_0_addra =
	     WILL_FIRE_RL_rl_write_request ?
	       rel_addr__h3893[23:2] :
	       rel_addr__h4792[23:2] ;
  assign ram_v_mem_0_addrb =
	     WILL_FIRE_RL_rl_read_request ?
	       rel_addr__h1996[23:2] :
	       rel_addr__h2924[23:2] ;
  assign ram_v_mem_0_dina = s_xactor_rg_wr_data[36:5] ;
  assign ram_v_mem_0_dinb =
	     WILL_FIRE_RL_rl_read_request ?
	       32'bxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx /* unspecified value */  :
	       32'bxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx /* unspecified value */  ;
  assign ram_v_mem_0_wea = s_xactor_rg_wr_data[4:1] ;
  assign ram_v_mem_0_web = 4'd0 ;
  ...
  assign _dor1s_xactor_crg_wr_resp_full_EN_port1__write =
	     WILL_FIRE_RL_rl_write_response || WILL_FIRE_RL_rl_write_request ;
  assign addr__h2007 = { 2'd0, rel_addr__h1996[23:2] } ;
  assign addr__h3146 = { 2'd0, rel_addr__h2924[23:2] } ;
  ...
  begin
    ...
    if (RST_N != `BSV_RESET_VALUE)
	  ...
	  (TASK_testplusargs___d139 ||
	   TASK_testplusargs___d140 && TASK_testplusargs___d141))
	$write("'h%h", s_xactor_rg_wr_data[36:5]);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_write_request &&
	  (TASK_testplusargs___d139 ||
	   TASK_testplusargs___d140 && TASK_testplusargs___d141))
    ...
    if (RST_N != `BSV_RESET_VALUE)
	  ...
	  (TASK_testplusargs___d139 ||
	   TASK_testplusargs___d140 && TASK_testplusargs___d141))
	$write("'h%h", s_xactor_rg_wr_data[4:1]);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_write_request &&
	  (TASK_testplusargs___d139 ||
	   TASK_testplusargs___d140 && TASK_testplusargs___d141))
