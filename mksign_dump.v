...
//
// On Fri Sep  3 12:09:00 PDT 2021
//
//
// Ports:
// Name                         I/O  size props
...
module mksign_dump(CLK,
  ...
  // register dataarray_2
  reg [31 : 0] dataarray_2;
  wire [31 : 0] dataarray_2_D_IN;
  wire dataarray_2_EN;

  // register dataarray_3
  reg [31 : 0] dataarray_3;
  wire [31 : 0] dataarray_3_D_IN;
  wire dataarray_3_EN;
  ...
  reg [35 : 0] m_xactor_rg_rd_data;
  wire [35 : 0] m_xactor_rg_rd_data_D_IN;
  ...
  reg [36 : 0] m_xactor_rg_wr_data;
  wire [36 : 0] m_xactor_rg_wr_data_D_IN;
  ...
  reg [1 : 0] rg_word_count;
  wire [1 : 0] rg_word_count_D_IN;
  wire rg_word_count_EN;
  ...
  wire [1 : 0] ff_lower_order_bits_D_IN, ff_lower_order_bits_D_OUT;
  ...
  wire [31 : 0] s_xactor_rg_wr_data_BITS_36_TO_5_MINUS_rg_star_ETC__q1;
  wire [4 : 0] lv_shift__h3764;
  ...
  // value method master_m_wdata
  assign master_WDATA = m_xactor_rg_wr_data[36:5] ;

  // value method master_m_wstrb
  assign master_WSTRB = m_xactor_rg_wr_data[4:1] ;
  ...
  assign MUX_rg_start_write_1__SEL_1 =
	     ...
	     rg_start_address != s_xactor_rg_wr_data[36:5] ;
  ...
  assign MUX_rg_total_count_write_1__VAL_1 =
	     { 2'd0,
	       s_xactor_rg_wr_data_BITS_36_TO_5_MINUS_rg_star_ETC__q1[31:2] } ;
  ...
  // register dataarray_2
  assign dataarray_2_D_IN = 32'h0 ;
  assign dataarray_2_EN = 1'b0 ;

  // register dataarray_3
  assign dataarray_3_D_IN = 32'h0 ;
  assign dataarray_3_EN = 1'b0 ;
  ...
  // register m_xactor_rg_wr_data
  assign m_xactor_rg_wr_data_D_IN = 37'h0 ;
  ...
  // register rg_end_address
  assign rg_end_address_D_IN = s_xactor_rg_wr_data[36:5] ;
  ...
  // register rg_word_count
  assign rg_word_count_D_IN = 2'h0 ;
  ...
  // register s_xactor_rg_rd_data
  assign s_xactor_rg_rd_data_D_IN = 36'h0 ;
  ...
  // submodule ff_lower_order_bits
  assign ff_lower_order_bits_D_IN = rg_start_address[1:0] ;
  ...
  // remaining internal signals
  assign lv_shift__h3764 = { ff_lower_order_bits_D_OUT, 3'd0 } ;
  assign rg_cnt_ULT_5___d2 = rg_cnt < 5'd5 ;
  assign rg_start_address_1_ULT_rg_end_address_8___d39 =
	     rg_start_address < rg_end_address ;
  assign s_xactor_rg_wr_data_BITS_36_TO_5_MINUS_rg_star_ETC__q1 =
	     s_xactor_rg_wr_data[36:5] - rg_start_address ;
  ...
  begin
	...
	dataarray_2 <= `BSV_ASSIGNMENT_DELAY 32'd0;
	dataarray_3 <= `BSV_ASSIGNMENT_DELAY 32'd0;
	...
	rg_word_count <= `BSV_ASSIGNMENT_DELAY 2'd3;
	...
	if (dataarray_2_EN)
	  dataarray_2 <= `BSV_ASSIGNMENT_DELAY dataarray_2_D_IN;
	if (dataarray_3_EN)
	  dataarray_3 <= `BSV_ASSIGNMENT_DELAY dataarray_3_D_IN;
  ...
  begin
    ...
    dataarray_2 = 32'hAAAAAAAA;
    dataarray_3 = 32'hAAAAAAAA;
    dump = 32'hAAAAAAAA;
    ...
    m_xactor_rg_rd_data = 36'hAAAAAAAAA;
    m_xactor_rg_wr_addr = 62'h2AAAAAAAAAAAAAAA;
    m_xactor_rg_wr_data = 37'h0AAAAAAAAA;
  ...
  begin
	...
	$fwrite(dump, "%4h\n", m_xactor_rg_rd_data[34:3] >> lv_shift__h3764);
    if (RST_N != `BSV_RESET_VALUE)
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_receive_response && m_xactor_rg_rd_data[2:1] != 2'b0)
	$display(v__h4036, "\tSIGNATUREDUMP got Bus Error");
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_receive_response && m_xactor_rg_rd_data[2:1] != 2'b0)
	$finish(32'd0);
  end
