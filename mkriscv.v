...
//
// On Fri Sep  3 12:09:38 PDT 2021
//
//
// Ports:
// Name                         I/O  size props
...
//   (ma_cache_ready_r, EN_ma_cache_ready, EN_dump_get) -> initiate_store_fst
//   (ma_cache_ready_r, EN_ma_cache_ready, EN_dump_get) -> initiate_store_snd
...
module mkriscv(resetpc,
  ...
  wire [34 : 0] instr_req_get;
  wire [31 : 0] mv_csr_mstatus, mv_pmp_cfg;
  ...
  wire [66 : 0] pipe2_meta_D_IN, pipe2_meta_D_OUT;
  wire pipe2_meta_CLR,
       pipe2_meta_DEQ,
       pipe2_meta_EMPTY_N,
       pipe2_meta_ENQ,
  ...
  wire [31 : 0] pipe2_mtval_D_IN, pipe2_mtval_D_OUT;
  ...
  wire [38 : 0] pipe3common_D_IN, pipe3common_D_OUT;
  ...
  wire [63 : 0] pipe3inst_D_IN, pipe3inst_D_OUT;
  wire pipe3inst_CLR,
       pipe3inst_DEQ,
       pipe3inst_EMPTY_N,
       pipe3inst_ENQ,
  ...
  wire [50 : 0] pipe3type_D_IN, pipe3type_D_OUT;
  wire pipe3type_CLR,
       pipe3type_DEQ,
       pipe3type_EMPTY_N,
       pipe3type_ENQ,
  ...
  wire [77 : 0] stage0_ma_train_bpu_td;
  wire [44 : 0] stage0_tx_to_stage1_enq_data;
  wire [34 : 0] stage0_to_icache_get;
  wire [32 : 0] stage0_ma_flush_fl;
  wire [8 : 0] stage0_ma_mispredict_g;
  ...
  wire [86 : 0] stage1_tx_to_stage2_enq_data;
  wire [44 : 0] stage1_rx_from_stage0_first_x;
  ...
  wire [100 : 0] stage2_csrs_csr;
  wire [86 : 0] stage2_rx_from_stage1_first_x;
  wire [66 : 0] stage2_tx_meta_to_stage3_enq_data;
  wire [39 : 0] stage2_mv_op2;
  wire [38 : 0] stage2_mv_op1;
  wire [37 : 0] stage2_commit_rd_commit, stage2_mv_op3;
  wire [31 : 0] stage2_rx_inst_first_x,
		stage2_tx_inst_enq_data,
		stage2_tx_mtval_to_stage3_enq_data;
  ...
  wire [77 : 0] stage3_mv_train_bpu;
  wire [70 : 0] stage3_memory_request_get;
  wire [66 : 0] stage3_rx_meta_from_stage2_first_x;
  wire [50 : 0] stage3_tx_type_to_stage4_enq_data;
  wire [39 : 0] stage3_fwd_from_pipe3_fwd,
		stage3_fwd_from_pipe4_first_fwd,
		stage3_ma_op2_i;
  wire [38 : 0] stage3_ma_op1_i, stage3_tx_common_to_stage4_enq_data;
  wire [37 : 0] stage3_ma_op3_i;
  wire [31 : 0] stage3_flush_from_exe_snd,
		stage3_next_pc_npc,
		stage3_rx_inst_first_x,
		stage3_rx_mtval_from_stage2_first_x,
		stage3_tx_inst_enq_data_fst,
		stage3_tx_inst_enq_data_snd;
  wire [7 : 0] stage3_mv_mispredict_snd;
  ...
  wire [71 : 0] stage4_tx_min_enq_data_fst;
  wire [63 : 0] stage4_rx_inst_first_x;
  wire [50 : 0] stage4_rx_type_from_stage3_first_x;
  wire [39 : 0] stage4_memory_response_put;
  wire [38 : 0] stage4_rx_common_from_stage3_first_x;
  wire [31 : 0] stage4_tx_inst_enq_data_fst, stage4_tx_inst_enq_data_snd;
  ...
  wire [115 : 0] stage5_mv_pmp_addr;
  wire [103 : 0] stage5_dump_get;
  wire [100 : 0] stage5_mv_csrs_to_decode;
  wire [72 : 0] stage5_rx_in_first_x;
  wire [63 : 0] stage5_ma_clint_mtime_c_mtime, stage5_rx_inst_first_x;
  wire [38 : 0] stage5_commit_rd;
  wire [33 : 0] stage5_write_resp_r;
  wire [31 : 0] stage5_flush_snd_fst,
  ...
  wire [39 : 0] MUX_stage3_fwd_from_pipe3_1__VAL_1,
		MUX_stage3_fwd_from_pipe3_1__VAL_2,
		MUX_stage3_fwd_from_pipe4_first_1__VAL_1,
		MUX_stage3_fwd_from_pipe4_first_1__VAL_2;

  // remaining internal signals
  wire [31 : 0] fl_pc__h10757, fwd_data__h11287;
  wire [19 : 0] _0_CONCAT_IF_wr_dcache_counters_whas_THEN_wr_dc_ETC___d26;
  wire [12 : 0] IF_wr_dcache_counters_whas_THEN_wr_dcache_coun_ETC___d3;
  wire [4 : 0] rd__h11276;
  ...
  // value method mv_pmp_cfg
  assign mv_pmp_cfg = stage5_mv_pmp_cfg ;
  assign RDY_mv_pmp_cfg = 1'd1 ;

  // value method mv_pmp_addr
  assign mv_pmp_addr = stage5_mv_pmp_addr ;
  ...
  // submodule pipe1
  FIFO2 #(.width(32'd87), .guarded(1'd1)) pipe1(.RST(RST_N),
						.CLK(CLK),
						.D_IN(pipe1_D_IN),
						.ENQ(pipe1_ENQ),
						.DEQ(pipe1_DEQ),
  ...
  FIFOL1 #(.width(32'd67)) pipe2_meta(.RST(RST_N),
				      .CLK(CLK),
  ...
  FIFOL1 #(.width(32'd32)) pipe2_mtval(.RST(RST_N),
				       .CLK(CLK),
  ...
  FIFO2 #(.width(32'd39), .guarded(1'd1)) pipe3common(.RST(RST_N),
						      .CLK(CLK),
  ...
  // submodule pipe3inst
  FIFO2 #(.width(32'd64), .guarded(1'd1)) pipe3inst(.RST(RST_N),
						    .CLK(CLK),
						    .D_IN(pipe3inst_D_IN),
						    .ENQ(pipe3inst_ENQ),
						    .DEQ(pipe3inst_DEQ),
  ...
  // submodule pipe3type
  FIFO2 #(.width(32'd51), .guarded(1'd1)) pipe3type(.RST(RST_N),
						    .CLK(CLK),
						    .D_IN(pipe3type_D_IN),
						    .ENQ(pipe3type_ENQ),
						    .DEQ(pipe3type_DEQ),
  ...
  // submodule pipe4
  FIFOL1 #(.width(32'd73)) pipe4(.RST(RST_N),
				 .CLK(CLK),
				 .D_IN(pipe4_D_IN),
				 .ENQ(pipe4_ENQ),
				 .DEQ(pipe4_DEQ),
  ...
  // submodule pipe4inst
  FIFOL1 #(.width(32'd64)) pipe4inst(.RST(RST_N),
				     .CLK(CLK),
				     .D_IN(pipe4inst_D_IN),
				     .ENQ(pipe4inst_ENQ),
				     .DEQ(pipe4inst_DEQ),
  ...
  mkstage5 #(.hartid(hartid)) stage5(.CLK(CLK),
				     .RST_N(RST_N),
				     .ma_cache_ready_r(stage5_ma_cache_ready_r),
				     ...
				     .ma_set_meip_ex_i(stage5_ma_set_meip_ex_i),
				     ...
				     .EN_ma_set_meip(stage5_EN_ma_set_meip),
				     .EN_write_resp(stage5_EN_write_resp),
				     .EN_ma_cache_ready(stage5_EN_ma_cache_ready),
				     ...
				     .RDY_flush_snd_fst(),
				     .flush_snd_snd(stage5_flush_snd_snd),
				     .RDY_flush_snd_snd(),
				     ...
				     .RDY_mv_resume_wfi(),
				     .mv_pmp_cfg(stage5_mv_pmp_cfg),
				     .RDY_mv_pmp_cfg(),
				     .mv_pmp_addr(stage5_mv_pmp_addr),
				     .RDY_mv_pmp_addr(),
				     .RDY_ma_events_grp4(),
				     .RDY_ma_events_grp5(),
				     .RDY_ma_events_grp6(),
  ...
  assign CAN_FIRE_RL_connect_csrs = stage5_RDY_mv_csrs_to_decode ;
  assign WILL_FIRE_RL_connect_csrs = stage5_RDY_mv_csrs_to_decode ;
  ...
  assign CAN_FIRE_RL_mkConnectionVtoAf =
	     stage0_RDY_ma_train_bpu && stage3_RDY_mv_train_bpu ;
  ...
  assign CAN_FIRE_RL_mkConnectionVtoAf_1 =
	     stage0_RDY_ma_mispredict && stage3_RDY_mv_mispredict_fst &&
	     stage3_RDY_mv_mispredict_snd ;
  ...
  assign MUX_stage3_fwd_from_pipe3_1__VAL_1 =
	     { (pipe3common_D_OUT[6:2] != 5'd0 || pipe3common_D_OUT[0]) &&
	       ...
	       pipe3type_D_OUT[50:49] == 2'd2,
	       pipe3common_D_OUT[6:2],
	       pipe3type_D_OUT[36:5],
	       pipe3common_D_OUT[0] } ;
  ...
  assign MUX_stage3_fwd_from_pipe4_first_1__VAL_1 =
	     { (rd__h11276 != 5'd0 || pipe4_D_OUT[72:71] != 2'd2 ||
		pipe4_D_OUT[1]) &&
	       pipe4_D_OUT[0] == rg_wEpoch,
	       pipe4_D_OUT[72:71] == 2'd2,
	       rd__h11276,
	       fwd_data__h11287,
	       pipe4_D_OUT[72:71] != 2'd2 || pipe4_D_OUT[1] } ;
  ...
  assign stage0_ma_flush_fl =
	     { fl_pc__h10757, stage5_flush_fst && stage5_flush_snd_snd } ;
  ...
  assign stage0_EN_ma_bpu_enable = stage5_RDY_mv_csrs_to_decode ;
  ...
  assign stage1_EN_csr_misa_c = stage5_RDY_mv_csrs_to_decode ;

  // submodule stage2
  assign stage2_clear_stall_upd = 1'd1 ;
  assign stage2_commit_rd_commit = stage5_commit_rd[37:0] ;
  ...
  assign stage2_EN_commit_rd = stage2_RDY_commit_rd && stage5_commit_rd[38] ;
  assign stage2_EN_csrs = stage5_RDY_mv_csrs_to_decode ;
  ...
  assign stage2_EN_ma_resume_wfi = stage5_RDY_mv_csrs_to_decode ;
  ...
  assign stage3_next_pc_npc = pipe1_D_OUT[86:55] ;
  ...
  // submodule stage5
  assign stage5_ma_cache_ready_r = ma_cache_ready_r ;
  ...
  assign stage5_ma_events_grp4_e =
	     { _0_CONCAT_IF_wr_dcache_counters_whas_THEN_wr_dc_ETC___d26,
	       stage3_mv_count_exestalls,
	       stage3_mv_count_rawstalls,
	       stage3_mv_count_muldiv,
	       stage3_mv_count_floats,
  ...
  assign stage5_ma_set_meip_ex_i = ma_set_meip_ex_i ;
  ...
  assign stage5_EN_ma_set_meip = EN_ma_set_meip ;
  assign stage5_EN_write_resp = EN_write_resp ;
  assign stage5_EN_ma_cache_ready = EN_ma_cache_ready ;
  ...
  // remaining internal signals
  assign IF_wr_dcache_counters_whas_THEN_wr_dcache_coun_ETC___d3 =
	     EN_ma_dcache_counters ? ma_dcache_counters_i : 13'd0 ;
  assign _0_CONCAT_IF_wr_dcache_counters_whas_THEN_wr_dc_ETC___d26 =
	     { 2'd0,
	       IF_wr_dcache_counters_whas_THEN_wr_dcache_coun_ETC___d3[0],
	       IF_wr_dcache_counters_whas_THEN_wr_dcache_coun_ETC___d3[1],
	       IF_wr_dcache_counters_whas_THEN_wr_dcache_coun_ETC___d3[2],
	       IF_wr_dcache_counters_whas_THEN_wr_dcache_coun_ETC___d3[3],
	       IF_wr_dcache_counters_whas_THEN_wr_dcache_coun_ETC___d3[4],
	       IF_wr_dcache_counters_whas_THEN_wr_dcache_coun_ETC___d3[5],
	       IF_wr_dcache_counters_whas_THEN_wr_dcache_coun_ETC___d3[6],
	       IF_wr_dcache_counters_whas_THEN_wr_dcache_coun_ETC___d3[7],
	       IF_wr_dcache_counters_whas_THEN_wr_dcache_coun_ETC___d3[8],
	       IF_wr_dcache_counters_whas_THEN_wr_dcache_coun_ETC___d3[9],
	       IF_wr_dcache_counters_whas_THEN_wr_dcache_coun_ETC___d3[10],
	       IF_wr_dcache_counters_whas_THEN_wr_dcache_coun_ETC___d3[11],
	       IF_wr_dcache_counters_whas_THEN_wr_dcache_coun_ETC___d3[12],
	       EN_ma_icache_counters ? ma_icache_counters_i : 5'd0 } ;
  assign fl_pc__h10757 =
	     stage5_flush_fst ?
	       stage5_flush_snd_fst :
	       stage3_flush_from_exe_snd ;
  assign fwd_data__h11287 =
	     (pipe4_D_OUT[72:71] == 2'd2) ? pipe4_D_OUT[43:12] : 32'd0 ;
  assign rd__h11276 =
	     (pipe4_D_OUT[72:71] == 2'd2) ? pipe4_D_OUT[11:7] : 5'd0 ;
