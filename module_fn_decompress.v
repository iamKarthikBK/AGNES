...
//
// On Fri Sep  3 12:09:26 PDT 2021
//
//
// Ports:
// Name                         I/O  size props
...
module module_fn_decompress(fn_decompress_inst,
  ...
  wire [31 : 0] IF_fn_decompress_inst_BITS_15_TO_11_24_EQ_0b10_ETC___d328,
		IF_fn_decompress_inst_BITS_15_TO_11_24_EQ_0b10_ETC___d331,
		IF_fn_decompress_inst_BITS_15_TO_12_EQ_0b1000__ETC___d330,
		IF_fn_decompress_inst_BITS_15_TO_12_EQ_0b1001__ETC___d327,
		IF_fn_decompress_inst_BITS_15_TO_13_EQ_0b0_AND_ETC___d335,
		IF_fn_decompress_inst_BITS_15_TO_13_EQ_0b100_9_ETC___d343,
		IF_fn_decompress_inst_BITS_15_TO_13_EQ_0b101_3_ETC___d326,
		IF_fn_decompress_inst_BITS_15_TO_13_EQ_0b101_3_ETC___d353,
		IF_fn_decompress_inst_BITS_15_TO_13_EQ_0b10_2__ETC___d333,
		IF_fn_decompress_inst_BITS_15_TO_13_EQ_0b10_2__ETC___d355,
		IF_fn_decompress_inst_BITS_15_TO_13_EQ_0b111_9_ETC___d351,
		IF_fn_decompress_inst_BITS_15_TO_13_EQ_0b1_2_A_ETC___d349,
		IF_fn_decompress_inst_BITS_15_TO_7_7_EQ_0b1110_ETC___d347;
  wire [11 : 0] SEXT_fn_decompress_inst_BIT_12_5_CONCAT_fn_dec_ETC___d78;
  wire [9 : 0] x__h1410, x__h4207;
  wire [8 : 0] x__h11094;
  wire [7 : 0] x__h12041, x__h1574;
  wire [6 : 0] x__h1876;
  wire [5 : 0] fn_decompress_inst_BIT_12_CONCAT_fn_decompress_ETC__q1;
  wire [3 : 0] x__h14287;
  wire [2 : 0] x__h14561, x__h2040;
  wire [1 : 0] x__h2384;
  wire fn_decompress_inst_BIT_10_AND_fn_decompress_in_ETC___d281,
       fn_decompress_inst_BIT_5_4_AND_fn_decompress_i_ETC___d292;
  ...
  // remaining internal signals
  assign IF_fn_decompress_inst_BITS_15_TO_11_24_EQ_0b10_ETC___d328 =
	     (fn_decompress_inst[15:11] == 5'b10011 &&
	      fn_decompress_inst[6:0] == 7'b0000010 ||
	      fn_decompress_inst[15:12] == 4'b1001 &&
	      fn_decompress_inst_BIT_10_AND_fn_decompress_in_ETC___d281) ?
	       { 12'd0, fn_decompress_inst[11:7], 15'd231 } :
	       IF_fn_decompress_inst_BITS_15_TO_12_EQ_0b1001__ETC___d327 ;
  assign IF_fn_decompress_inst_BITS_15_TO_11_24_EQ_0b10_ETC___d331 =
	     (fn_decompress_inst[15:11] == 5'b10001 &&
	      ...
	      fn_decompress_inst_BIT_10_AND_fn_decompress_in_ETC___d281) ?
	       ...
	       IF_fn_decompress_inst_BITS_15_TO_12_EQ_0b1000__ETC___d330 ;
  assign IF_fn_decompress_inst_BITS_15_TO_12_EQ_0b1000__ETC___d330 =
	     (fn_decompress_inst[15:12] == 4'b1000 &&
		 ...
		 7'd51 } :
		  ...
		  32'd1048691 :
		  IF_fn_decompress_inst_BITS_15_TO_11_24_EQ_0b10_ETC___d328) ;
  assign IF_fn_decompress_inst_BITS_15_TO_12_EQ_0b1001__ETC___d327 =
	     (fn_decompress_inst[15:12] == 4'b1001 &&
	      (fn_decompress_inst[6] && fn_decompress_inst[1:0] == 2'b10 ||
	       fn_decompress_inst_BIT_5_4_AND_fn_decompress_i_ETC___d292)) ?
	       { 7'b0,
		 ...
		 7'd51 } :
	       IF_fn_decompress_inst_BITS_15_TO_13_EQ_0b101_3_ETC___d326 ;
  assign IF_fn_decompress_inst_BITS_15_TO_13_EQ_0b0_AND_ETC___d335 =
	     (fn_decompress_inst[15:13] == 3'b0 &&
		 ...
		 7'd19 } :
	       ((fn_decompress_inst[15:13] == 3'b001 &&
		 fn_decompress_inst[1:0] == 2'b10) ?
		  { 3'd0, x__h11094, 8'd19, fn_decompress_inst[11:7], 7'd7 } :
		  IF_fn_decompress_inst_BITS_15_TO_13_EQ_0b10_2__ETC___d333) ;
  assign IF_fn_decompress_inst_BITS_15_TO_13_EQ_0b100_9_ETC___d343 =
	     (fn_decompress_inst[15:13] == 3'b100 &&
	      fn_decompress_inst[11:10] == 2'b10 &&
	      fn_decompress_inst[1:0] == 2'b01) ?
	       { SEXT_fn_decompress_inst_BIT_12_5_CONCAT_fn_dec_ETC___d78,
		 2'b01,
		 fn_decompress_inst[9:7],
		 5'b11101,
		 fn_decompress_inst[9:7],
				 ...
				 ((fn_decompress_inst[15:13] == 3'b111 &&
				   fn_decompress_inst[1:0] == 2'b01) ?
				    { fn_decompress_inst[12],
				      ...
				      7'd99 } :
				    IF_fn_decompress_inst_BITS_15_TO_13_EQ_0b0_AND_ETC___d335))))))) ;
  assign IF_fn_decompress_inst_BITS_15_TO_13_EQ_0b101_3_ETC___d326 =
	     (fn_decompress_inst[15:13] == 3'b101 &&
	      fn_decompress_inst[1:0] == 2'b10) ?
	       { 3'd0,
		 x__h14287,
		  ...
		  ((fn_decompress_inst[15:13] == 3'b111 &&
		    fn_decompress_inst[1:0] == 2'b10) ?
		     { 4'd0,
		       ...
		       9'd39 } :
		     32'd0)) ;
  assign IF_fn_decompress_inst_BITS_15_TO_13_EQ_0b101_3_ETC___d353 =
	     (fn_decompress_inst[15:13] == 3'b101 &&
	      fn_decompress_inst[1:0] == 2'b0) ?
	       { 4'd0,
		 x__h2040,
		 ...
		 fn_decompress_inst[1:0] == 2'b0) ?
		  { 5'd0,
		    ...
		    9'd35 } :
		  IF_fn_decompress_inst_BITS_15_TO_13_EQ_0b111_9_ETC___d351) ;
  assign IF_fn_decompress_inst_BITS_15_TO_13_EQ_0b10_2__ETC___d333 =
	     (fn_decompress_inst[15:13] == 3'b010 &&
	      (fn_decompress_inst[11] || fn_decompress_inst[10] ||
	       ...
	       fn_decompress_inst[7]) &&
	      fn_decompress_inst[1:0] == 2'b10) ?
	       { 4'd0, x__h12041, 8'd18, fn_decompress_inst[11:7], 7'd3 } :
	       ((fn_decompress_inst[15:13] == 3'b011 &&
		 fn_decompress_inst[1:0] == 2'b10) ?
		  { 4'd0, x__h12041, 8'd18, fn_decompress_inst[11:7], 7'd7 } :
		  IF_fn_decompress_inst_BITS_15_TO_11_24_EQ_0b10_ETC___d331) ;
  assign IF_fn_decompress_inst_BITS_15_TO_13_EQ_0b10_2__ETC___d355 =
	     (fn_decompress_inst[15:13] == 3'b010 &&
	      fn_decompress_inst[1:0] == 2'b0) ?
	       { 5'd0,
		 x__h1876,
		 ...
		 fn_decompress_inst[1:0] == 2'b0) ?
		  { 5'd0,
		    ...
		    7'd7 } :
		  IF_fn_decompress_inst_BITS_15_TO_13_EQ_0b101_3_ETC___d353) ;
  assign IF_fn_decompress_inst_BITS_15_TO_13_EQ_0b111_9_ETC___d351 =
	     (fn_decompress_inst[15:13] == 3'b111 &&
	      fn_decompress_inst[1:0] == 2'b0) ?
	       { 5'd0,
		 x__h2384,
		 ...
		 fn_decompress_inst[1:0] == 2'b01) ?
		  { SEXT_fn_decompress_inst_BIT_12_5_CONCAT_fn_dec_ETC___d78,
		    ...
		    7'd19 } :
		  IF_fn_decompress_inst_BITS_15_TO_13_EQ_0b1_2_A_ETC___d349) ;
  assign IF_fn_decompress_inst_BITS_15_TO_13_EQ_0b1_2_A_ETC___d349 =
	     (fn_decompress_inst[15:13] == 3'b001 &&
	      fn_decompress_inst[1:0] == 2'b01) ?
	       { fn_decompress_inst[12],
		 fn_decompress_inst[8],
		 ...
		 fn_decompress_inst[1:0] == 2'b01) ?
		  { SEXT_fn_decompress_inst_BIT_12_5_CONCAT_fn_dec_ETC___d78,
		    ...
		    7'd19 } :
		  IF_fn_decompress_inst_BITS_15_TO_7_7_EQ_0b1110_ETC___d347) ;
  assign IF_fn_decompress_inst_BITS_15_TO_7_7_EQ_0b1110_ETC___d347 =
		...
		fn_decompress_inst[2:0] == 3'b101))) ?
	       { { {2{x__h4207[9]}}, x__h4207 }, 20'd65811 } :
		 ...
		 (fn_decompress_inst[11] && fn_decompress_inst[6] &&
		  ...
		  ((fn_decompress_inst[15:13] == 3'b100 &&
			...
			{ 6'b010000,
			  ...
			  7'd19 } :
			IF_fn_decompress_inst_BITS_15_TO_13_EQ_0b100_9_ETC___d343))) ;
  assign SEXT_fn_decompress_inst_BIT_12_5_CONCAT_fn_dec_ETC___d78 =
	     { {6{fn_decompress_inst_BIT_12_CONCAT_fn_decompress_ETC__q1[5]}},
	       fn_decompress_inst_BIT_12_CONCAT_fn_decompress_ETC__q1 } ;
  assign fn_decompress_inst_BIT_10_AND_fn_decompress_in_ETC___d281 =
	     fn_decompress_inst[10] &&
	     fn_decompress_inst[6:0] == 7'b0000010 ||
  ...
  assign fn_decompress_inst_BIT_5_4_AND_fn_decompress_i_ETC___d292 =
  ...
  assign x__h1410 =
	     { fn_decompress_inst[10:7],
	       ...
	       fn_decompress_inst[6],
	       2'd0 } ;
  assign x__h14287 = { fn_decompress_inst[9:7], fn_decompress_inst[12] } ;
  assign x__h14561 = { fn_decompress_inst[8:7], fn_decompress_inst[12] } ;
  assign x__h1574 =
  ...
  assign x__h1876 =
	     { fn_decompress_inst[5],
	       ...
	       fn_decompress_inst[6],
	       2'd0 } ;
  assign x__h2040 = { fn_decompress_inst[6:5], fn_decompress_inst[12] } ;
  assign x__h2384 = { fn_decompress_inst[5], fn_decompress_inst[12] } ;
  assign x__h4207 =
	     { fn_decompress_inst[12],
	       fn_decompress_inst[4:3],
	       fn_decompress_inst[5],
