...
module mk_csr_grp3(CLK,
  ...
  reg [31 : 0] rg_mcycle;
  wire [31 : 0] rg_mcycle_D_IN;
  wire rg_mcycle_EN;

  // register rg_mcycleh
  // reg : higher 32 bits of cycle counter
  reg [31 : 0] rg_mcycleh;
  wire [31 : 0] rg_mcycleh_D_IN;
  wire rg_mcycleh_EN;
  ...
  reg [31 : 0] rg_minstret;
  wire [31 : 0] rg_minstret_D_IN;
  wire rg_minstret_EN;

  // register rg_minstreth
  // reg : higher 32 bits of instruction counter
  reg [31 : 0] rg_minstreth;
  wire [31 : 0] rg_minstreth_D_IN;
  wire rg_minstreth_EN;
  ...
  wire MUX_rg_mcycle_write_1__SEL_1,
       MUX_rg_mcycleh_write_1__SEL_1,
       MUX_rg_minstret_write_1__SEL_1;

  // remaining internal signals
  reg [31 : 0] IF_ma_core_req_req_BITS_47_TO_36_2_EQ_0xB00_0__ETC___d48,
	       v__h1436;
  wire [63 : 0] instr__h3701,
		instr__h3702,
		new_cycle__h946,
		rg_mcycleh_CONCAT_rg_mcycle_PLUS_1___d9;
  wire [31 : 0] x__h3221,
		x_data__h1326,
		x_wget_fst__h1552,
		x_wget_snd_fst__h1637;
  wire [30 : 0] r1__read__h1342;
  wire [29 : 0] r1__read__h1344;
  wire [1 : 0] x_wget_snd_snd__h1638;
  ...
  assign MUX_rg_mcycle_write_1__SEL_1 =
	     EN_ma_core_req && ma_core_req_req[47:36] == 12'hB00 ;
  assign MUX_rg_mcycleh_write_1__SEL_1 =
	     EN_ma_core_req && ma_core_req_req[47:36] == 12'hB80 ;
  assign MUX_rg_minstret_write_1__SEL_1 = EN_ma_incr_minstret && !rg_ir ;

  // inlined wires
  always@(ma_core_req_req or
	  IF_ma_core_req_req_BITS_47_TO_36_2_EQ_0xB00_0__ETC___d48)
  begin
  ...
  assign rg_resp_to_core_1_whas =
	     EN_ma_core_req &&
	     (ma_core_req_req[47:36] == 12'hF11 ||
	      ma_core_req_req[47:36] == 12'hF12 ||
	      ma_core_req_req[47:36] == 12'hF13 ||
	      ma_core_req_req[47:36] == 12'hF14 ||
	      ma_core_req_req[47:36] == 12'hB00 ||
	      ma_core_req_req[47:36] == 12'hB02 ||
	      ma_core_req_req[47:36] == 12'h306 ||
	      ma_core_req_req[47:36] == 12'h320 ||
	      ma_core_req_req[47:36] == 12'h7C2 ||
	      ma_core_req_req[47:36] == 12'hB80 ||
	      ma_core_req_req[47:36] == 12'hB82) ;
  ...
  // register rg_cy
  assign rg_cy_D_IN = v__h1436[0] ;
  assign rg_cy_EN = EN_ma_core_req && ma_core_req_req[47:36] == 12'h320 ;

  // register rg_hpm_enabler
  assign rg_hpm_enabler_D_IN = v__h1436[31:3] ;
  assign rg_hpm_enabler_EN =
	     EN_ma_core_req && ma_core_req_req[47:36] == 12'h320 ;

  // register rg_ir
  assign rg_ir_D_IN = v__h1436[2] ;
  assign rg_ir_EN = EN_ma_core_req && ma_core_req_req[47:36] == 12'h320 ;

  // register rg_mcounteren
  assign rg_mcounteren_D_IN = v__h1436 ;
  assign rg_mcounteren_EN =
	     EN_ma_core_req && ma_core_req_req[47:36] == 12'h306 ;

  // register rg_mcycle
  assign rg_mcycle_D_IN =
	     MUX_rg_mcycle_write_1__SEL_1 ?
	       v__h1436 :
	       rg_mcycleh_CONCAT_rg_mcycle_PLUS_1___d9[31:0] ;
  assign rg_mcycle_EN =
	     EN_ma_core_req && ma_core_req_req[47:36] == 12'hB00 ||
	     WILL_FIRE_RL_increment_cycle_counter && !rg_cy ;

  // register rg_mcycleh
  assign rg_mcycleh_D_IN =
	     MUX_rg_mcycleh_write_1__SEL_1 ?
	       v__h1436 :
	       rg_mcycleh_CONCAT_rg_mcycle_PLUS_1___d9[63:32] ;
  assign rg_mcycleh_EN =
	     EN_ma_core_req && ma_core_req_req[47:36] == 12'hB80 ||
	     WILL_FIRE_RL_increment_cycle_counter && !rg_cy ;

  // register rg_mhpminterrupten
  assign rg_mhpminterrupten_D_IN = v__h1436 ;
  assign rg_mhpminterrupten_EN =
	     EN_ma_core_req && ma_core_req_req[47:36] == 12'h7C2 ;

  // register rg_minstret
  assign rg_minstret_D_IN =
	     MUX_rg_minstret_write_1__SEL_1 ? instr__h3702[31:0] : v__h1436 ;
  assign rg_minstret_EN =
	     EN_ma_core_req && ma_core_req_req[47:36] == 12'hB02 ||
	     EN_ma_incr_minstret && !rg_ir ;

  // register rg_minstreth
  assign rg_minstreth_D_IN =
	     MUX_rg_minstret_write_1__SEL_1 ? instr__h3702[63:32] : v__h1436 ;
  assign rg_minstreth_EN =
	     EN_ma_core_req && ma_core_req_req[47:36] == 12'hB82 ||
	     EN_ma_incr_minstret && !rg_ir ;
  ...
  assign ff_fwd_request_ENQ =
	     EN_ma_core_req && ma_core_req_req[47:36] != 12'hF11 &&
	     ma_core_req_req[47:36] != 12'hF12 &&
	     ma_core_req_req[47:36] != 12'hF13 &&
	     ma_core_req_req[47:36] != 12'hF14 &&
	     ma_core_req_req[47:36] != 12'hB00 &&
  ...
  // remaining internal signals
  module_fn_csr_op instance_fn_csr_op_0(.fn_csr_op_writedata(x_wget_fst__h1552),
					.fn_csr_op_readdata(x_wget_snd_fst__h1637),
					.fn_csr_op_op(x_wget_snd_snd__h1638),
					.fn_csr_op(x__h3221));
  assign instr__h3701 = { rg_minstreth, rg_minstret } ;
  assign instr__h3702 = instr__h3701 + 64'd1 ;
  assign new_cycle__h946 = { rg_mcycleh, rg_mcycle } ;
  assign r1__read__h1342 = { r1__read__h1344, 1'd0 } ;
  assign r1__read__h1344 = { rg_hpm_enabler, rg_ir } ;
  assign rg_mcycleh_CONCAT_rg_mcycle_PLUS_1___d9 = new_cycle__h946 + 64'd1 ;
  assign x_data__h1326 = { r1__read__h1342, rg_cy } ;
  assign x_wget_fst__h1552 = csr_op_arg_wget[65:34] ;
  assign x_wget_snd_fst__h1637 = csr_op_arg_wget[33:2] ;
  assign x_wget_snd_snd__h1638 = csr_op_arg_wget[1:0] ;
  always@(ma_core_req_req or
	  rg_minstreth or
	  rg_mcounteren or
	  x_data__h1326 or
	  rg_mhpminterrupten or rg_mcycle or rg_minstret or rg_mcycleh)
  begin
    case (ma_core_req_req[47:36])
      12'h306:
	  IF_ma_core_req_req_BITS_47_TO_36_2_EQ_0xB00_0__ETC___d48 =
	  ...
	  IF_ma_core_req_req_BITS_47_TO_36_2_EQ_0xB00_0__ETC___d48 =
	      rg_mcycleh;
      default: IF_ma_core_req_req_BITS_47_TO_36_2_EQ_0xB00_0__ETC___d48 =
		   rg_minstreth;
    endcase
  end
  always@(ma_core_req_req or x__h3221)
  begin
    case (ma_core_req_req[47:36])
      12'h306, 12'h320, 12'h7C2, 12'hB00, 12'hB02: v__h1436 = x__h3221;
      default: v__h1436 = x__h3221;
    endcase
  end
  ...
  begin
	...
	rg_mcycle <= `BSV_ASSIGNMENT_DELAY 32'd0;
	rg_mcycleh <= `BSV_ASSIGNMENT_DELAY 32'd0;
	rg_mhpminterrupten <= `BSV_ASSIGNMENT_DELAY 32'd0;
	rg_minstret <= `BSV_ASSIGNMENT_DELAY 32'd0;
	rg_minstreth <= `BSV_ASSIGNMENT_DELAY 32'd0;
	...
	if (rg_mcycleh_EN)
	  rg_mcycleh <= `BSV_ASSIGNMENT_DELAY rg_mcycleh_D_IN;
	...
	if (rg_minstreth_EN)
	  rg_minstreth <= `BSV_ASSIGNMENT_DELAY rg_minstreth_D_IN;
  ...
  begin
    ...
    rg_mcycle = 32'hAAAAAAAA;
    rg_mcycleh = 32'hAAAAAAAA;
    rg_mhpminterrupten = 32'hAAAAAAAA;
    rg_minstret = 32'hAAAAAAAA;
    rg_minstreth = 32'hAAAAAAAA;
