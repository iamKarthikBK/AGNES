...
module mkmulticycle_alu(CLK,
  ...
  input  [31 : 0] ma_inputs_op1;
  input  [31 : 0] ma_inputs_op2;
  input  [31 : 0] ma_inputs_op3;
  input  [3 : 0] ma_inputs_inst_type;
  input  EN_ma_inputs;
  output RDY_ma_inputs;

  // value method mv_delayed_output
  output [37 : 0] mv_delayed_output;
  output RDY_mv_delayed_output;

  // signals for module outputs
  wire [37 : 0] mv_delayed_output;
  wire RDY_ma_inputs, RDY_mv_delayed_output;

  // ports of submodule fpu
  wire [37 : 0] fpu_get_result;
  wire [31 : 0] fpu__start_operand1, fpu__start_operand2, fpu__start_operand3;
  ...
  wire [37 : 0] mbox_mv_output;
  wire [31 : 0] mbox_ma_inputs_in1, mbox_ma_inputs_in2;
  wire [2 : 0] mbox_ma_inputs_funct3;
  wire mbox_EN_ma_inputs, mbox_RDY_mv_output;
