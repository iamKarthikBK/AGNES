...
//
// On Fri Sep  3 12:08:16 PDT 2021
//
//
// Ports:
// Name                         I/O  size props
...
module mkregisterfile(CLK,
  ...
  wire [31 : 0] read_rs1, read_rs2, read_rs3;
  ...
  wire [31 : 0] integer_rf_D_IN, integer_rf_D_OUT_1, integer_rf_D_OUT_2;
  ...
  assign MUX_integer_rf_upd_1__SEL_1 =
	     EN_commit_rd && !commit_rd_c[0] && commit_rd_c[37:33] != 5'd0 ;
  ...
  assign floating_rf_ADDR_IN =
	     MUX_floating_rf_upd_1__SEL_1 ? commit_rd_c[37:33] : rg_index ;
  assign floating_rf_D_IN =
	     MUX_floating_rf_upd_1__SEL_1 ? commit_rd_c[32:1] : 32'd0 ;
  ...
  assign integer_rf_ADDR_IN =
	     MUX_integer_rf_upd_1__SEL_1 ? commit_rd_c[37:33] : rg_index ;
  assign integer_rf_D_IN =
	     MUX_integer_rf_upd_1__SEL_1 ? commit_rd_c[32:1] : 32'd0 ;
