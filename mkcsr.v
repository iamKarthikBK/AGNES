...
//
// On Fri Sep  3 12:09:10 PDT 2021
//
//
// Ports:
// Name                         I/O  size props
// system_instruction             O    33
...
//    system_instruction_funct3) -> system_instruction
...
module mkcsr(CLK,
  ...
  output [32 : 0] system_instruction;
  ...
  wire [32 : 0] mv_resp_to_core, system_instruction;
  wire [31 : 0] mv_csr_mstatus, mv_pmp_cfg, take_trap;
  ...
  wire [100 : 0] csrfile_mv_csrs_to_decode;
  wire [63 : 0] csrfile_ma_clint_mtime_c_mtime;
  wire [47 : 0] csrfile_ma_core_req_req;
  wire [32 : 0] csrfile_mv_resp_to_core;
  wire [31 : 0] csrfile_mav_upd_on_ret,
  ...
  reg [63 : 0] v__h707;
  reg system_instruction_csr_address_BITS_11_TO_8_EQ_ETC___d15;
  ...
  // inlined wires
  assign rg_csr_wait_1_wget = !rg_csr_wait || !csrfile_mv_resp_to_core[32] ;
  ...
  begin
    ...
    if (RST_N != `BSV_RESET_VALUE)
	  ...
	  (system_instruction_csr_address[11:8] == 4'h0 ||
	   system_instruction_csr_address[11:8] == 4'h3))
	begin
	  TASK_testplusargs___d11 = $test$plusargs("mcsr");
	  #0;
	end
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_system_instruction && system_instruction_funct3 == 3'd0 &&
	  (system_instruction_csr_address[11:8] == 4'h0 ||
	   system_instruction_csr_address[11:8] == 4'h3))
	begin
	  TASK_testplusargs___d12 = $test$plusargs("l1");
	  #0;
	end
    system_instruction_csr_address_BITS_11_TO_8_EQ_ETC___d15 =
	(system_instruction_csr_address[11:8] == 4'h0 ||
	 system_instruction_csr_address[11:8] == 4'h3) &&
