...
//
// On Fri Sep  3 12:08:21 PDT 2021
//
//
// Ports:
// Name                         I/O  size props
...
module mkfwding(CLK,
  ...
  wire [31 : 0] IF_wr_from_pipe4_first_wget__2_BIT_39_3_AND_wr_ETC___d101,
		IF_wr_from_pipe4_first_wget__2_BIT_39_3_AND_wr_ETC___d68,
		IF_wr_from_pipe4_first_wget__2_BIT_39_3_AND_wr_ETC___d86;
  wire wr_from_pipe4_first_wget__2_BITS_37_TO_33_5_EQ_ETC___d56,
       wr_from_pipe4_first_wget__2_BITS_37_TO_33_5_EQ_ETC___d77,
       wr_from_pipe4_first_wget__2_BITS_37_TO_33_5_EQ_ETC___d92,
  ...
  // actionvalue method read_rs1
  assign read_rs1 =
	     (fwd_from_pipe3_fwd[39] &&
	      fwd_from_pipe3_fwd[37:33] == read_rs1_addr &&
	      fwd_from_pipe3_fwd[0] == read_rs1_rftype) ?
	       { fwd_from_pipe3_fwd[38], fwd_from_pipe3_fwd[32:1] } :
	       { !fwd_from_pipe4_first_fwd[39] ||
		 !wr_from_pipe4_first_wget__2_BITS_37_TO_33_5_EQ_ETC___d56 ||
		 !wr_from_pipe4_first_wget__2_BIT_0_9_EQ_read_rs_ETC___d60 ||
		 fwd_from_pipe4_first_fwd[38],
		 IF_wr_from_pipe4_first_wget__2_BIT_39_3_AND_wr_ETC___d68 } ;
  ...
  assign read_rs2 =
	     (fwd_from_pipe3_fwd[39] &&
	      fwd_from_pipe3_fwd[37:33] == read_rs2_addr &&
  ...
  assign read_rs3 =
	     (fwd_from_pipe3_fwd[39] &&
	      fwd_from_pipe3_fwd[37:33] == read_rs3_addr &&
		 ...
		 !wr_from_pipe4_first_wget__2_BIT_0_9_EQ_read_rs_ETC___d95 ||
		 fwd_from_pipe4_first_fwd[38],
		 IF_wr_from_pipe4_first_wget__2_BIT_39_3_AND_wr_ETC___d101 } ;
  assign RDY_read_rs3 = 1'b1 ;
  assign CAN_FIRE_read_rs3 = 1'b1 ;
  assign WILL_FIRE_read_rs3 = EN_read_rs3 ;

  // remaining internal signals
  assign IF_wr_from_pipe4_first_wget__2_BIT_39_3_AND_wr_ETC___d101 =
	     (fwd_from_pipe4_first_fwd[39] &&
	      wr_from_pipe4_first_wget__2_BITS_37_TO_33_5_EQ_ETC___d92 &&
	      wr_from_pipe4_first_wget__2_BIT_0_9_EQ_read_rs_ETC___d95) ?
	       fwd_from_pipe4_first_fwd[32:1] :
	       read_rs3_val ;
  assign IF_wr_from_pipe4_first_wget__2_BIT_39_3_AND_wr_ETC___d68 =
	     (fwd_from_pipe4_first_fwd[39] &&
	      wr_from_pipe4_first_wget__2_BITS_37_TO_33_5_EQ_ETC___d56 &&
	      wr_from_pipe4_first_wget__2_BIT_0_9_EQ_read_rs_ETC___d60) ?
	       fwd_from_pipe4_first_fwd[32:1] :
	       read_rs1_val ;
  assign IF_wr_from_pipe4_first_wget__2_BIT_39_3_AND_wr_ETC___d86 =
	     (fwd_from_pipe4_first_fwd[39] &&
	      wr_from_pipe4_first_wget__2_BITS_37_TO_33_5_EQ_ETC___d77 &&
	      wr_from_pipe4_first_wget__2_BIT_0_9_EQ_read_rs_ETC___d80) ?
	       fwd_from_pipe4_first_fwd[32:1] :
	       read_rs2_val ;
  assign wr_from_pipe4_first_wget__2_BITS_37_TO_33_5_EQ_ETC___d56 =
	     fwd_from_pipe4_first_fwd[37:33] == read_rs1_addr ;
  assign wr_from_pipe4_first_wget__2_BITS_37_TO_33_5_EQ_ETC___d77 =
	     fwd_from_pipe4_first_fwd[37:33] == read_rs2_addr ;
  assign wr_from_pipe4_first_wget__2_BITS_37_TO_33_5_EQ_ETC___d92 =
	     fwd_from_pipe4_first_fwd[37:33] == read_rs3_addr ;
  ...
  begin
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (TASK_testplusargs___d1 ||
	  TASK_testplusargs___d2 && TASK_testplusargs___d3)
	$write("[%2d]FWDING: from PIPE3: ", hartid);
    if (RST_N != `BSV_RESET_VALUE)
      if (TASK_testplusargs___d1 ||
	  TASK_testplusargs___d2 && TASK_testplusargs___d3)
	$write("FwdType { ", "valid: ");
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (TASK_testplusargs___d1 ||
	  TASK_testplusargs___d2 && TASK_testplusargs___d3)
	$write("'h%h", fwd_from_pipe3_fwd[37:33]);
    if (RST_N != `BSV_RESET_VALUE)
      if (TASK_testplusargs___d1 ||
	  TASK_testplusargs___d2 && TASK_testplusargs___d3)
	$write(", ", "data: ");
    if (RST_N != `BSV_RESET_VALUE)
      if (TASK_testplusargs___d1 ||
	  TASK_testplusargs___d2 && TASK_testplusargs___d3)
	$write("'h%h", fwd_from_pipe3_fwd[32:1]);
    if (RST_N != `BSV_RESET_VALUE)
      if (TASK_testplusargs___d1 ||
	  TASK_testplusargs___d2 && TASK_testplusargs___d3)
	$write(", ", "rftype: ");
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (TASK_testplusargs___d21 ||
	  TASK_testplusargs___d22 && TASK_testplusargs___d23)
	$write("[%2d]FWDING: from PIPE4-first: ", hartid);
    if (RST_N != `BSV_RESET_VALUE)
      if (TASK_testplusargs___d21 ||
	  TASK_testplusargs___d22 && TASK_testplusargs___d23)
	$write("FwdType { ", "valid: ");
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (TASK_testplusargs___d21 ||
	  TASK_testplusargs___d22 && TASK_testplusargs___d23)
	$write("'h%h", fwd_from_pipe4_first_fwd[37:33]);
    if (RST_N != `BSV_RESET_VALUE)
      if (TASK_testplusargs___d21 ||
	  TASK_testplusargs___d22 && TASK_testplusargs___d23)
	$write(", ", "data: ");
    if (RST_N != `BSV_RESET_VALUE)
      if (TASK_testplusargs___d21 ||
	  TASK_testplusargs___d22 && TASK_testplusargs___d23)
	$write("'h%h", fwd_from_pipe4_first_fwd[32:1]);
    if (RST_N != `BSV_RESET_VALUE)
      if (TASK_testplusargs___d21 ||
	  TASK_testplusargs___d22 && TASK_testplusargs___d23)
	$write(", ", "rftype: ");
